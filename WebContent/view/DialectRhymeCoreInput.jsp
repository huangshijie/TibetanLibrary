		...
		<div class="wrap" style="width: 80%; margin: 30px auto;">
			...
			<div class="content" style="padding:20px;border-radius: 4px;">
				<div class="container" style="width: 100%;">
					<div class="row">
						<h1 style="margin: auto; width: initial; padding: 46px; width: 30%;">方言韵核输入</h1>
					</div>
					<div class="row">
						...
						<div class="col-md-8" style="text-align:center">
							...
							<div class="row" style="padding:10px; text-align:center">
								...
								<div class="col-md-4" style="text-align:center"><input style="width:100%"/></div>
								<div class="col-md-4" style="text-align:center"><button type="button" class="btn">确定</button></div>
							</div>
							<div class="row">
